    ...
    <>
      ...
      {showNotifications && (
        <>
          ...
          ></div>
          <div
            className="fixed top-20 right-4 w-80 max-h-[58vh] rounded-xl overflow-hidden shadow-lg bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border dark:border-gray-700/40 z-50"
      ...
      {showAll && (
        <>
          ...
          >
            <div
              className="w-full max-w-xl max-h-[82vh] rounded-2xl overflow-hidden shadow-lg bg-white dark:bg-gray-800 border dark:border-gray-700"
              onClick={(e) => e.stopPropagation()}
            >
